...
export class MarketConditionsRiskModule implements RiskModule {
  async evaluate(input: RiskEvaluationInput): Promise<RiskModuleResult> {
    ...
    return {
      module_name: "market_conditions_risk",
      ...
      metadata: {
        ...
        quality_flag: input.snapshot.context.quality_flag,
        market_session_context: input.snapshot.context.session,
      },
    };
  }
}
